...
import { Container, Grid, Segment, Header, Form, Button, Label, Input } from 'semantic-ui-react';
  ...
  render() {
    return (
        <Container centered>
              ...
              {this.state.show &&
              (<Segment compact>
                <p className='ghg-results'>{this.calculateGHG()} kg of CO2 is emitted from traveling {this.state.inputVMT} miles with a vehicle
