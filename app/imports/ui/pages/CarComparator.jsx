            ...
            <Grid.Column floated='left' width='7' >
              <Slider {...settings}>
                <div>
                  ...
                  <Header as="h3">Vehicle Cost: $26,250</Header>
                  <Header as="h3">Emissions made: 8.2 tons per year</Header>
                  <Header as="h3">Annual Fuel Cost: $2,050</Header>
                </div>
                <div>
                  ...
                  <Header as="h3">Vehicle Cost: $24,020</Header>
                  <Header as="h3">Emissions made: 5.1 tons per year</Header>
                  <Header as="h3">Annual Fuel Cost: $1,250</Header>
                </div>
                <div>
                  <h2>Toyota Camry</h2>
                  <Tilt trackOnWindow={true} tiltReverse={true} tiltMaxAngleX={'10'} tiltMaxAngleY={'10'}
                  ...
                  <Header as="h3">Vehicle Cost: $19,395</Header>
                  <Header as="h3">Emissions made: 6.4 tons per year</Header>
                  <Header as="h3">Annual Fuel Cost: $1,600</Header>
                </div>
              </Slider>
            </Grid.Column>
            <div></div>
            <Grid.Column floated='right' width='7'>
              <Slider {...settings}>
                <div>
                  ...
                  <Header as="h3">Electric Vehicle Cost: $35,000</Header>
                  <Header as="h3">Fuel Saved Per Year: $850</Header>
                  <Header as="h3">State Discounts: N/A</Header>
                </div>
                <div>
                  <h2>Toyota Prius</h2>
                  <Tilt trackOnWindow={true} tiltReverse={true} tiltMaxAngleX={'10'} tiltMaxAngleY={'10'}
                  ...
                  <Header as="h3">Electric Vehicle Cost: $27,600 </Header>
                  <Header as="h3">Fuel Saved Per Year: $750</Header>
                  <Header as="h3">State Discounts: Possible Tax Break</Header>
                </div>
                <div>
                  <h2>Nissan Leaf</h2>
                  <Tilt trackOnWindow={true} tiltReverse={true} tiltMaxAngleX={'10'} tiltMaxAngleY={'10'}
                  ...
                  <Header as="h3">Electric Vehicle Cost: $29,990 </Header>
                  <Header as="h3">Fuel Saved Per Year: $750</Header>
                  <Header as="h3">State Discounts: Possible Tax Break</Header>
                </div>
              </Slider>
